...
function preload() {
  ...
  for (i = 0; i < 21; i++) {
    if (i < 10) {
      bubblesPop[i] = loadImage(`../../assets/images/bubbles/bubblesPop_0${i}.png`)
    } else {
      bubblesPop[i] = loadImage(`../../assets/images/bubbles/bubblesPop_${i}.png`)
    }
  }

  popSound[0] = loadSound('../../assets/images/bubbles/bubble_pop.mp3');
}
