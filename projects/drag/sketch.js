...
function preload() {
  ...
  folder1img = loadImage('../../assets/images/homePage/greenFolder_0.png');
  folder2img = loadImage('../../assets/images/homePage/purpleFolder_0.png');
  folder3img = loadImage('../../assets/images/homePage/chartreuseFolder_0.png');
  trashImg = loadImage('../../assets/images/homePage/trashempty.png');
  screenshotImg = loadImage('../../assets/images/homePage/folder_icons_Screenshot_1.png');
  tagalongImg = loadImage('../../assets/images/homePage/folder_icons_tagalong.png');
  roboto = loadFont('../../assets/images/homePage/Roboto-Regular.ttf');
...
function setup() {
  ...
  folder1.addAnimation('still', '../../assets/images/homePage/greenFolder_0.png');
  folder1.addAnimation('kick', '../../assets/images/homePage/greenFolder_1.png', '../../assets/images/homePage/greenFolder_4.png');
  folder2 = createSprite(width / 4, height - 400, 200, 101);
  folder2.addAnimation('still', '../../assets/images/homePage/purpleFolder_0.png');
  folder2.addAnimation('kick', '../../assets/images/homePage/purpleFolder_1.png', '../../assets/images/homePage/purpleFolder_4.png');
  folder3 = createSprite(width / 5, height - 350, 200, 101);
  folder3.addAnimation('still', '../../assets/images/homePage/chartreuseFolder_0.png');
  folder3.addAnimation('kick', '../../assets/images/homePage/chartreuseFolder_1.png', '../../assets/images/homePage/chartreuseFolder_4.png');
