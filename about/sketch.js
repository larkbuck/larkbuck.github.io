...
// don't need draw loop, no reason for p5 to be looping
// function draw() {
// }
...
function highlight() {
    ...
    //var s = this.html().replace(/(\w+)/, "peace") //but he stopped! doing this bc already in "this"
    this.html('rainbow');
...
function replacer(match, group1, group2) {
    ...
    // console.log(group1);
    // console.log(group2);
    //instead of writing out different arguments, you can
    //use javascripts arguments array
